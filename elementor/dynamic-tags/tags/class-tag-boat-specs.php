...
abstract class Abstract_Boat_Spec_Tag extends Abstract_BT_Tag {
    ...
    protected function register_controls(): void {
        ...
        $this->add_control('show_suffix', [
            'label'        => __('Afficher l\'unité', 'bt-regiondo'),
        ...
        $this->add_control('suffix_text', [
            'label'     => __('Texte unité', 'bt-regiondo'),
        ...
        $this->add_control('fallback', [
            'label'   => __('Texte si vide', 'bt-regiondo'),
            'type'    => \Elementor\Controls_Manager::TEXT,
            'default' => '',
        ]);
    }
...
class Tag_Boat_Pax extends Abstract_Boat_Spec_Tag {
    ...
    protected function field_name():     string { return 'boat_pax_max'; }
    protected function default_suffix(): string { return 'pax'; }

    // Bonus : choix entre max légal et confort
    protected function register_controls(): void {
        $this->add_control('pax_field', [
            'label'   => __('Champ', 'bt-regiondo'),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => [
                'boat_pax_max'     => __('Max légal (boat_pax_max)', 'bt-regiondo'),
                'boat_pax_comfort' => __('Confort optimal (boat_pax_comfort)', 'bt-regiondo'),
            ],
