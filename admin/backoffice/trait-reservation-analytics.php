...
/**
 * Trait ReservationAnalytics — requêtes analytiques sur bt_reservations.
 *
 * Utilise $this->table (string) et self::EDATE (const) définis dans ReservationDb.
 * Toutes les méthodes query_* d'analytics sont ici.
 */
trait ReservationAnalytics {
    ...
    /**
     * Top N produits par nombre de réservations + revenue.
     */
    ...
    /**
     * Distribution par heure de réservation.
     */
    ...
    /**
     * Distribution par avance de réservation (buckets).
     */
    ...
    /**
     * Top N dates par volume de réservation.
     */
    ...
    /**
     * Top dates par volume d'annulations.
     */
    ...
    /**
     * KPIs enrichis : lead time, repeat rate, revenue/jour, etc.
     */
    ...
    /**
     * Derive customer list from bt_reservations.
     */
